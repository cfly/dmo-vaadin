package cn.spdup.dmo.data.generator;

import cn.spdup.dmo.data.Role;
import cn.spdup.dmo.data.entity.SamplePerson;
import cn.spdup.dmo.data.entity.User;
import cn.spdup.dmo.data.service.SamplePersonRepository;
import cn.spdup.dmo.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 6, 4, 0, 0, 0));
