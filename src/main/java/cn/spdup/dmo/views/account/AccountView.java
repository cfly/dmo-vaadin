package cn.spdup.dmo.views.account;

import cn.spdup.dmo.data.entity.SamplePerson;
import cn.spdup.dmo.data.service.SamplePersonService;
import cn.spdup.dmo.views.MainLayout;
...
public class AccountView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "account/%s/edit";
    ...
    @Autowired
    public AccountView(SamplePersonService samplePersonService) {
